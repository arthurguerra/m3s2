...
public class InscricaoTest {
    ...
    private static Integer matriculaAluno = null;
    ...
    public void inserirInscricao() throws JsonProcessingException {
        InscricaoReqDTO request = new InscricaoReqDTO(matriculaAluno, codigoCurso);
        String json = mapper.writeValueAsString(request);
        given()
                .header("Authorization", "Bearer " + tokenJWT)
                .contentType(ContentType.JSON)
                ...
                .body("matriculaAluno", is(matriculaAluno))
                .body("codigoCurso", is(codigoCurso));
    }
}
